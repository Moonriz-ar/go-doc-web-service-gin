...
func getAlbums(c *gin.Context) { // gin.Context is the most important part of Gin. It carries requrest details, validates and serializes JSON, and more
...
func postAlbums(c *gin.Context) {
	...
	// this way of creating err variable is local to the scope within if statement
...
func getAlbumByID(c *gin.Context) {
	// retrieve id path parameter from the URL
	id := c.Param("id")
